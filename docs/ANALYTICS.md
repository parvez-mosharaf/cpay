...
Boltpay's home page uses the Amplitude unified browser SDK from `src/home-analytics.js`. The source is bundled with esbuild into `public/assets/home-analytics.js`; the generated bundle is referenced only by `public/index.html`. Other static pages do not initialize Amplitude.
